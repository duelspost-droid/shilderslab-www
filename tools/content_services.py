  ...
  <div class="shell">
    <div class="svc-list">
      ...
      <a class="svc-row" href="/services/privacy/">
        ...
        <p>수집부터 파기까지 데이터가 실제로 어떻게 흐르는지 따라갑니다.
           구간마다 법적 근거와 안전성 확보조치 이행 상태를 확인합니다.</p>
        <span class="go">자세히 →</span>
      </a>
      <a class="svc-row" href="/services/cloud/">
        <span class="n">05</span>
        <div><span class="for">Cloud</span><h3>클라우드 보안</h3></div>
        <p>IAM 권한 범위, 스토리지 공개 설정, 로그 활성화 여부를 계정 단위로 확인합니다.
           AWS·Azure·GCP 각각의 기본 설정 중 그대로 두면 위험한 항목부터 봅니다.</p>
        <span class="go">자세히 →</span>
      </a>
      <a class="svc-row" href="/services/governance/">
        <span class="n">06</span>
        <div><span class="for">Governance</span><h3>보안 거버넌스 · 교육</h3></div>
        <p>문서로만 있는 대응 절차는 사고 당일에 작동하지 않습니다.
           정책을 만든 뒤 모의훈련으로 한 번 돌려보고, 어긋난 지점을 반영해 넘겨드립니다.</p>
        <span class="go">자세히 →</span>
      </a>
    </div>
  </div>
...
DETAILS = [
    ...
    },
    {
        ...
        "body": _detail(
            "privacy", "개인정보",
            "방침 말고<br>흐름을 봅니다",
            "개인정보 문제는 방침 문서보다 실제 처리 과정에서 생깁니다. "
            "수집부터 파기까지 데이터가 어떻게 흐르는지 따라가며 법적 근거와 조치 이행 상태를 확인합니다.",
            when=[
    ...
    },
    {
        ...
        "body": _detail(
            "cloud", "클라우드",
            "초기 설정 그대로<br>남아 있는 것들",
            "클라우드에서 문제가 되는 자리는 대개 새 기술이 아닙니다. 만들 때 설정을 그대로 두고 잊은 곳입니다. "
    ...
    },
    {
        ...
        "body": _detail(
            ...
            "대응이 늦어지는 자리는 문서가 없는 곳이 아니라 문서와 현장이 다른 곳입니다. "
            "정책을 만든 뒤 모의훈련으로 돌려보고, 어긋난 지점을 반영합니다.",
            when=[
                "보안 담당 조직을 새로 만들었다.",
