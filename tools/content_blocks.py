...
BLOCKS = [
    ...
    dict(
        ...
        default=(
            "**SHIELD** 지킨다 · **US** 우리를 · **LAB** 연구한다. "
            "사명은 이 세 낱말을 그대로 이어 붙인 것입니다. "
            "국문 **쉴더스랩**은 ‘shield us’를 이어 읽은 음차이므로, 영문과 국문은 다른 이름이 아니라 같은 말입니다.\n\n"
            "**US** 는 고객사를 가리키는 말이면서 저희를 포함하는 말입니다. "
            "보안은 지켜 주는 쪽과 지킴받는 쪽으로 나뉘지 않습니다. "
            "같은 위협 아래 있는 사람들이 같은 편에서 막는 일입니다. "
            "그래서 저희는 진단을 넘겨주고 끝내지 않고, 조치가 닫힐 때까지 함께 봅니다.\n\n"
            "**LAB** 은 연구를 뜻합니다. 저희에게 연구는 방법을 공개하는 일입니다. "
    ...
    dict(
        ...
        default="SHIELD 지킨다 · US 우리를 · LAB 연구한다 — 우리를 지키는 방법을 연구한다는 뜻입니다. "
                "국문 쉴더스랩은 ‘shield us’를 이어 읽은 음차로, 영문과 국문은 같은 말입니다. "
                "로고의 실드와 그 안의 각인도 이 뜻에서 나왔습니다.",
    ),
    # ─────────────────────────── 푸터 ───────────────────────────
    dict(
