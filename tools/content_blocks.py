...
BLOCKS = [
    ...
    dict(key="home.careers_title", kind="text", section="홈", label="06 채용 — 제목",
         hint="공개 채용 공고가 있을 때만 이 섹션이 홈에 나옵니다. 줄바꿈이 그대로 반영됩니다.",
         default="함께 볼 사람을 찾습니다"),
    dict(key="home.careers_lead", kind="text", section="홈", label="06 채용 — 소개 문단",
         hint="공고 목록 자체는 [채용] 탭에서 관리합니다. 여기는 그 위에 붙는 소개 문구입니다.",
         default="컨설팅은 결국 사람이 하는 일이라, 채용은 서비스 품질과 같은 문제로 봅니다. 지금 열려 있는 자리입니다."),
