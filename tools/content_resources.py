...
RES_BODY = """<section class="phead">
  <div class="shell">
    ...
    <p class="lead">담당자에게 지금 필요한 것은 회사 소개가 아니라 점검할 목록입니다.
       저희가 실제 과업에서 쓰는 자료를 그대로 공개합니다.
...
_ISMS_BODY = """      <p>같은 규모의 조직인데 어떤 곳은 준비에 6개월, 어떤 곳은 1년 반이 걸립니다.
         차이는 대개 문서량이 아니라 <b>지금 남아 있는 운영 기록</b>과 <b>범위 확정 여부</b>에서 갈립니다.
...
RES_DOCS = [
    ...
    },
    {
        ...
        "body": _doc(
            "ISMS-P 자가점검",
            "ISMS-P 착수 전<br>자가점검",
            "준비 기간을 좌우하는 것은 문서량이 아니라 지금 남아 있는 운영 기록입니다. "
