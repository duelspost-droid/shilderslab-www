...
TRUST_BODY = """<section class="phead">
  <div class="shell">
    ...
    <p class="lead">보안 컨설팅을 맡긴다는 것은 가장 약한 부분을 외부에 보여준다는 뜻입니다.
       신생 조직이라면 더더욱 “그래서 우리 데이터는 어떻게 되나”가 첫 질문이어야 합니다.
       그 질문에 계약 전에 답합니다.</p>
  </div>
</section>
  ...
  <div class="shell">
    ...
    <div class="trust-kv">
      ...
      <div class="row"><div class="k">인력 통제</div>
        <div class="v">수행 인력은 개별 비밀유지 서약을 하며, 과업 배정 이력과 접근 기록을 남깁니다.
          과업 중 인력이 교체되는 경우 사전 통보합니다.</div></div>
  ...
  <div class="shell">
    <div class="sec-head">
      ...
      <div class="body">
        ...
        <p class="lead">보안 회사의 웹사이트가 점검되지 않은 상태라면 그 자체가 답입니다.
           이 사이트에 적용한 조치와, <b>아직 남아 있는 위험</b>을 함께 공개합니다.</p>
      </div>
    </div>
    <div class="g12">
      <div class="c6">
