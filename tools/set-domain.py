...
⚠ 링크뿐 아니라 **본문 산문에 적힌 도메인까지** 바꾼다.
  "명함에는 X 가 새겨져 있다" 같은 **설명문에 주소를 리터럴로 쓰면 전환 방향에 따라
  문장이 거꾸로 뒤집힌다.** 실제로 `/brand/` 인쇄 보류 경고가 뒤집혔다(2026-08-01).
  그런 문장에는 주소를 적지 말고 "전환 예정 도메인" 처럼 가리키는 말을 쓴다.
