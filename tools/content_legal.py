...
<section class="sec tight">
  <div class="wrap doc">
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td data-l="항목">회사명, 담당자 성명, 이메일, (선택) 연락처, 문의 내용</td>
          <td data-l="목적">문의 접수·확인, 상담 및 견적 회신, 과업 범위 협의</td>
          <td data-l="기간">문의 처리 완료 후 1년 (이후 지체 없이 파기)</td>
        </tr>
        <tr>
          <td data-l="구분">채용 지원</td>
          <td data-l="항목">성명, 이메일, (선택) 연락처, 지원 직무, 경력 요약, (선택) 포트폴리오·이력서 링크</td>
          <td data-l="목적">채용 전형 진행, 전형 결과 안내</td>
          <td data-l="기간">해당 채용 전형 종료 후 6개월 (동의 철회 시 즉시 파기)</td>
        </tr>
        <tr>
    ...
    <p>문의·지원 과정에서 개인정보를 수집할 때에는 수집 항목, 목적, 보유 기간을 안내하고
       정보주체의 <b>동의를 받은 후</b>에 처리합니다. 필수 항목 외 선택 항목은 미기재해도 서비스 이용에 제한이 없습니다.</p>
    ...
    <table>
      <thead><tr><th>수탁자</th><th>위탁 업무</th><th>이전 항목</th><th>이전 국가 · 보유기간</th></tr></thead>
      <tbody>
        <tr>
          <td data-l="수탁자">GitHub, Inc.</td>
          <td data-l="업무">웹사이트 호스팅(GitHub Pages) 및 전송 구간 운영</td>
          <td data-l="항목">접속 IP, 접속 일시, 요청 정보</td>
          <td data-l="국가">미국 · 위탁 계약 종료 시까지</td>
        </tr>
        <tr>
          <td data-l="수탁자">Supabase, Inc.</td>
    ...
    <p>권리 행사는 <a href="mailto:contact@shilderslab.com" style="color:var(--cy-300)">contact@shilderslab.com</a>
       ...
       정보주체가 요구한 열람·정정·삭제 요청은 법령에서 정한 사유가 없는 한 제한하지 않습니다.</p>
    ...
    <ul>
      ...
      <li>상호 및 대표자, 사업장 주소, 개인정보 보호책임자 정보는 본 페이지 하단(사업자 정보)에 표시됩니다.</li>
    </ul>
...
<section class="sec tight">
  <div class="wrap doc">
    ...
    <p>본 약관은 본 사이트가 제공하는 정보 및 문의·지원 접수 기능(이하 “서비스”)의 이용에 관하여
       쉴더스랩과 이용자 간의 권리·의무 및 책임 사항을 규정함을 목적으로 합니다.
    ...
    <p>본 사이트의 보안 인사이트 등 콘텐츠는 일반적인 정보 제공을 목적으로 하며,
       ...
       회사는 콘텐츠의 정확성을 위해 노력하지만, 이용자가 콘텐츠에 근거해 취한 조치의 결과에 대해서는 책임을 지지 않습니다.</p>
    ...
    <h2>제8조 (약관의 변경)</h2>
    <p>회사는 필요한 경우 본 약관을 변경할 수 있으며, 변경된 약관은 본 사이트에 공지함으로써 효력이 발생합니다.
       이용자가 변경된 약관에 동의하지 않는 경우 서비스 이용을 중단할 수 있습니다.</p>

    <h2>제9조 (준거법 및 관할)</h2>
    <p>본 약관은 대한민국 법령에 따라 해석되며, 서비스 이용과 관련하여 분쟁이 발생한 경우
