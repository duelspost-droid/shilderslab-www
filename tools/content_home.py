...
BODY = """<section class="home-hero">
  <div class="shell g12">
    <div class="c7">
      ...
      <h1>닫혔는지 확인하고<br>끝냅니다</h1>
      <p class="lead sub">ISMS-P 인증 대응과 모의해킹·취약점 진단을 한 계약 안에서 함께 합니다.
         발견한 항목에는 재현 절차를 붙입니다.
         조치가 적용됐는지 재점검으로 확인한 뒤 과업을 닫습니다.</p>
      <div class="acts">
  ...
  <div class="shell">
    <div class="sec-head">
      ...
      <div class="body">
        ...
        <p class="lead">인증 심사 대응과 기술 진단을 하나의 범위 정의서 안에서 설계합니다.
           두 과업을 다른 업체에 나눠 맡기면 같은 자산을 두 번 조사하고도,
           심사에서 지적된 결함과 실제 침해 경로가 서로 연결되지 않은 채 남습니다.</p>
      </div>
    </div>
  ...
  <div class="shell">
    ...
    <div class="open-grid">
      ...
      <div class="o rv d2">
        ...
        <h3>수행할 수 없는 과업</h3>
        <p>정보보호 전문서비스기업 지정이 필요한 과업과 지정 평가기관만 수행하는 영향평가는
           수주하지 않습니다. 착수한 다음에 못 한다고 말하면 고객사 일정이 무너지기 때문입니다.</p>
    ...
    <div class="g12" style="margin-top:72px">
      <div class="c6">
        <div class="pull">
          <p>재점검에서 확인되지 않은 항목은 “조치 완료”로 적지 않습니다.
             확인하지 못한 이유와 함께 잔여위험 목록에 남기고, 그 목록을 최종 산출물에 넣습니다.</p>
          <cite>보고서 작성 규칙</cite>
        </div>
      </div>
      <div class="c5 start8">
  ...
  <div class="shell">
    <div class="sec-head">
      ...
      <div class="body">
        ...
        <p class="lead">진단할 때 실제로 쓰는 체크리스트를 그대로 올려 두었습니다.
           로그인도, 이메일 입력도 필요 없습니다. 다른 업체와 일하실 때 쓰셔도 됩니다.</p>
      </div>
    </div>
    <div class="cols cols-3 divided">
...
<section class="sec band-dark cta">
  <div class="shell g12">
    <div class="c7">
      ...
      <p class="lead">어디부터 봐야 할지 막막하시면 범위부터 같이 정리해 드립니다.
         진단 대상과 목표 일정만 알려주시면 필요한 항목과 예상 기간을 회신드립니다.
         범위 검토와 견적 산정 단계까지는 비용을 청구하지 않습니다.</p>
    </div>
