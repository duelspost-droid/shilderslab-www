...
먼저 공개합니다', 'text', '진단 방법론', '상단 큰 제목', '줄바꿈이 그대로 반영됩니다.', 30),
  ('method.hero_lead', '제안서를 여러 곳에서 받아 놓고도 무엇을 기준으로 비교해야 할지 막막할 때가 있습니다. 쉴더스랩은 그래서 실제로 쓰는 5단계 절차와 위험도 산정 기준, 산출물 규격을 계약 전에 공개합니다. 감추면 비교가 안 되니까요.', 'text', '진단 방법론', '상단 소개 문단', '', 40),
  ('resources.hero_title', '계약 없이도
바로 쓰실 수 있게', 'text', '자료실', '상단 큰 제목', '줄바꿈이 그대로 반영됩니다.', 50),
  ('resources.hero_lead', '저희가 과업에서 쓰는 문서를 손질 없이 그대로 올렸으니, 로그인이나 이메일 주소를 남기실 필요 없이 바로 여시면 됩니다. **다른 업체와 일하실 때 쓰셔도 됩니다.** 애초에 그러라고 공개한 문서입니다.', 'text', '자료실', '상단 소개 문단', '', 60),
  ('trust.hero_title', '우리에게 맡긴 것이
어떻게 다뤄지는지', 'text', '신뢰 센터', '상단 큰 제목', '줄바꿈이 그대로 반영됩니다.', 70),
  ('trust.hero_lead', '진단이 끝나도 구성도와 계정 체계, 취약점 목록은 저희 쪽에 남기 때문에 그 자료를 어디에 두는지, 얼마나 갖고 있다가 어떻게 없애는지를 아래에 적었습니다. 계약 전에 미리 보셔도 됩니다.', 'text', '신뢰 센터', '상단 소개 문단', '', 80),
  ('regulations.hero_title', '무엇이 우리에게
해당되는가', 'text', '규제 가이드', '상단 큰 제목', '줄바꿈이 그대로 반영됩니다.', 90),
  ('regulations.hero_lead', '제도 이름은 익숙한데 우리 회사가 어디에 걸리는지는 애매하실 겁니다. 그래서 국내 정보보호 제도를 근거 법령과 대상, 주기로 나란히 놓고 정리했습니다. 다만 수치와 해석은 원문으로 최종 확인하시는 편이 안전합니다.', 'text', '규제 가이드', '상단 소개 문단', '법령·제도 서술이 섞여 있습니다. 사실관계는 원문으로 확인하고 고치세요.', 100),
  ('insights.hero_title', '현장에서
반복되는 것들', 'text', '인사이트', '상단 큰 제목', '줄바꿈이 그대로 반영됩니다. 글 목록은 [인사이트] 탭에서 관리합니다.', 110),
  ('insights.hero_lead', '진단을 나가면 조직은 달라도 같은 문제가 반복됩니다. 규제 해석이 갈리는 지점, 조치가 자주 미끄러지는 지점, 그리고 실제로 통했던 방법을 기록합니다.', 'text', '인사이트', '상단 소개 문단', '', 120),
  ('careers.hero_title', '근거로 말하는
사람을 찾습니다', 'text', '채용', '상단 큰 제목', '줄바꿈이 그대로 반영됩니다. 공고는 [채용 공고] 탭에서 관리합니다.', 130),
  ('careers.hero_lead', '“아마 취약할 것 같다”가 아니라 “이렇게 재현된다”로 말하는 사람과 일합니다. 경력의 길이보다 검증하는 습관을 봅니다.', 'text', '채용', '상단 소개 문단', '', 140),
  ('contact.hero_title', '범위부터
같이 정리합니다', 'text', '문의', '상단 큰 제목', '줄바꿈이 그대로 반영됩니다.', 150),
  ('contact.hero_lead', '무엇이 필요한지 확정되지 않아도 괜찮습니다. 현재 상황만 알려주시면 필요한 진단과 우선순위, 예상 일정을 정리해 회신드립니다. **범위 검토와 견적 산정에는 비용이 발생하지 않습니다.**', 'text', '문의', '상단 소개 문단', '비용 청구 여부 같은 약속이 들어 있습니다. 실제 운영과 맞는지 확인하고 고치세요.', 160),
  ('about.hero_title', '확인한 것만
보고서에 씁니다', 'text', '회사소개', '상단 큰 제목', '줄바꿈한 자리에서 실제로 줄이 바뀝니다. 3줄을 넘기지 않는 편이 좋습니다.', 170),
  ('about.hero_lead', '쉴더스랩(SHIELDUS LAB)은 ISMS-P 인증 대응과 모의해킹·취약점 진단을 한 계약 안에서 수행하는 정보보호 컨설팅 회사이며, 진단으로 찾아낸 항목이 실제 조치로 이어지는 데까지를 과업 범위로 봅니다. 그래서 보고서 제출은 중간 지점입니다.', 'text', '회사소개', '상단 소개 문단', '제목 아래 한 문단. 검색 결과에도 영향을 주는 문장입니다.', 180),
  ('about.view_title', '발견마다 담당자와
순서를 붙입니다', 'text', '회사소개', '01 관점 — 제목', '줄바꿈이 그대로 반영됩니다.', 190),
...
그래서 저희는 발견마다 걸리는 규제 조항과 그 항목을 받아 갈 담당 조직을 함께 붙이고, 조치가 적용됐는지는 재점검에서 직접 열어 확인합니다. “지금은 안전한가”라는 질문까지 답한 뒤에 과업을 닫습니다.', 'rich', '회사소개', '01 관점 — 본문', '빈 줄로 문단을 나눕니다. **굵게** 로 강조합니다.', 200),
  ('about.name_title', '이름이 곧
하는 일입니다', 'text', '회사소개', '02 사명 — 제목', '줄바꿈이 그대로 반영됩니다.', 210),
...
**LAB**은 방법을 열어 둔다는 뜻으로 씁니다. 진단 순서와 위험도 등급 기준을 계약 전에 공개하고, 발견 하나하나에 재현 절차를 적습니다. 다시 해 봐도 같은 결과가 나오지 않는 항목은 연구 결과라고 부를 수 없습니다.', 'rich', '회사소개', '02 사명 — 본문', '사명의 뜻(SHIELD·US·LAB)을 설명하는 문단입니다. 빈 줄로 문단을 나누고 **굵게** 를 씁니다.', 220),
  ('about.message_title', '대표이사 인사말', 'text', '대표이사 인사말', '제목', '', 230),
...
방법론과 산출물 규격을 계약 전에 공개하는 것도 같은 이유에서입니다. 저희 판정이 맞는지 고객사가 직접 되짚어 볼 수 있어야 하니까요. 어디부터 봐야 할지 모르시겠다면 그 이야기부터 꺼내 주셔도 됩니다. 범위를 정하는 일에서부터 시작하겠습니다.', 'rich', '대표이사 인사말', '본문', '빈 줄로 문단을 나눕니다. **굵게** 사용 가능. 경력·자격을 넣으실 때는 사실만 적어 주세요.', 240),
  ('about.message_role', '쉴더스랩 대표이사', 'text', '대표이사 인사말', '서명 — 직함', '', 250),
  ('about.message_name', '이성훈', 'text', '대표이사 인사말', '서명 — 성명', '푸터의 ‘대표자’ 표기와는 별개입니다. 그쪽은 [법인 정보]의 대표자명을 씁니다.', 260),
  ('services.hero_title', '보고서가 두 개면
우선순위도 두 개입니다', 'text', '서비스', '상단 큰 제목', '줄바꿈이 그대로 반영됩니다.', 270),
  ('services.hero_lead', '관리체계는 A업체, 기술진단은 B업체. 이렇게 갈라 맡기면 담당자 책상 위에 위험도 기준이 서로 다른 보고서 두 권이 놓입니다. 어느 쪽 “높음”을 먼저 잡아야 하는지는 어느 쪽에도 적혀 있지 않습니다. 여섯 영역의 발견을 같은 등급 정의로 판정해 우선순위 목록 하나로 묶는 이유입니다.', 'text', '서비스', '상단 소개 문단', '서비스 목록 위에 놓이는 한 문단입니다.', 280),
  ('brand.name_summary', 'shield us, 우리를 지킨다. 이어 읽으면 쉴더스가 되고, 여기에 연구를 뜻하는 LAB이 붙었습니다. 로고의 실드와 그 안의 각인도 같은 뜻에서 나왔습니다.', 'text', '브랜드 · CI', '사명의 뜻 (요약)', '/brand/ 맨 위에 놓이는 요약입니다. 자세한 설명은 [회사소개]의 ‘02 사명’ 블록에 있습니다.', 290),
  ('footer.blurb', 'ISMS-P 인증 대응과 기술 진단을 한 계약 안에서 수행하는 정보보호 컨설팅 회사입니다. 발견에는 재현 절차를, 종료에는 재점검을 붙입니다.', 'text', '푸터', '푸터 소개 문단', '모든 페이지 하단에 공통으로 나옵니다.', 300),
  ('company.legal_name', '', 'text', '법인 정보', '등기 상호', '예: 주식회사 쉴더스랩. 비워두면 ‘쉴더스랩’으로 표시됩니다.', 310),
  ('company.ceo', '이성훈', 'text', '법인 정보', '대표자명', '푸터 사업자 정보에 표시됩니다.', 320),
  ('company.biz_no', '', 'text', '법인 정보', '사업자등록번호', '예: 000-00-00000', 330),
  ('company.addr', '', 'text', '법인 정보', '사업장 주소', '', 340),
  ('company.tel', '', 'text', '법인 정보', '대표번호', '', 350),
  ('company.fax', '', 'text', '법인 정보', '팩스', '', 360),
  ('company.privacy_officer', '', 'text', '법인 정보', '개인정보 보호책임자', '개인정보처리방침이 이 값을 참조합니다. 대외 홍보 전에 채워야 고지 요건이 완성됩니다.', 370)
...
-- 확인: 블록 수가 아래와 같아야 한다.
-- select count(*) from public.sl_content;   -- => 37
